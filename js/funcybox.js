...
!(function (t, e) {
                ...
                o(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this.viewportDim = { top: 0, left: 0, width: 0, height: 0 }),
                                ...
                                (this.drag = { startTime: null, firstPosition: null, startPosition: null, startPoint: null, startDistance: null, endPosition: null, endPoint: null, distance: 0, distanceX: 0, distanceY: 0, elapsedTime: 0 }),
                                (this.lockAxis = null),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var l = this.contentDim.width,
                                ...
                                u = l * t,
                                f = c * t;
                            null === n && (n = 0.5 * h), null === s && (s = 0.5 * d), !1 === this.option("zoomInCentered") && (n < 0.5 * h && (n = h), n > h && (n = 0), s < 0 && (s = d), s > d && (s = 0));
                            var v = h > 0 ? n / h : 0,
                                p = d > 0 ? s / d : 0,
                                g = (u - h) * (v - 0.5),
                                m = (f - d) * (p - 0.5);
                            Math.abs(g) < 1 && (g = 0), Math.abs(m) < 1 && (m = 0), (n = this.current.x - g), (s = this.current.y - m), this.panTo({ x: n, y: s, scale: t, friction: r });
                        },
                    },
                    {
                        key: "panTo",
                        value: function (t) {
                            ...
                            return l > 0 && (Math.abs(i - this.current.x) > 0.1 || Math.abs(o - this.current.y) > 0.1 || Math.abs(a - this.current.scale) > 0.1)
                                ? ((this.state = "panning"),
                                  (this.friction = l),
                                  (this.pan = { x: i, y: o, scale: a }),
                                  (this.velocity = { x: (1 / this.friction - 1) * (i - this.current.x), y: (1 / this.friction - 1) * (o - this.current.y), scale: (1 / this.friction - 1) * (a - this.current.scale) }),
                                  this.animate(),
                                  this)
                                : (this.pendingAnimateUpdate && (cancelAnimationFrame(this.pendingAnimateUpdate), (this.pendingAnimateUpdate = null)),
                                  (this.state = "ready"),
                                  this.stopMoving(),
                        ...
                        value: function () {
                            ...
                            if (!this.pendingAnimateUpdate) {
                                if (
                                    ...
                                    "dragging" == this.state || "pointerdown" == this.state || Math.abs(this.velocity.x) > 0.05 || Math.abs(this.velocity.y) > 0.05 || Math.abs(this.velocity.scale) > 0.05)
                                )
                                    return (
                                        this.transform(),
                                ...
                                (this.current.x = y(this.current.x + this.velocity.x / (1 / this.friction - 1))),
                                    ...
                                    (this.current.scale = y(this.current.scale + this.velocity.scale / (1 / this.friction - 1), 1e4)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            t &&
                                this.option("touch") &&
                                (this.contentDim.width <= this.viewportDim.width && 1 == this.option("panOnlyZoomed") && this.current.scale <= this.option("baseScale") ? this.$viewport.classList.remove(t) : this.$viewport.classList.add(t));
                        },
                    },
                    {
                        key: "isMoved",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            Math.abs(t) <= 0.1 && Math.abs(e) <= 0.1 && Math.abs(i - 1) <= 0.1 ? (this.$content.style.transform = "") : (this.$content.style.transform = "translate(".concat(t, "px, ").concat(e, "px) scale(").concat(i, ")")),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.resizeObserver =
                                    ...
                                    t.pendingResizeUpdate =
                                        ...
                                        setTimeout(function () {
                                            ...
                                            !i && t.$viewport && (i = t.$viewport.getBoundingClientRect()),
                                                i && (Math.abs(i.width - t.viewportDim.width) > 1 || Math.abs(i.height - t.viewportDim.height) > 1) && t.updateMetrics(),
                                ...
                                this.option("touch") &&
                                    (window.PointerEvent
                                        ? (e.addEventListener("pointerdown", this.onPointerDown, { passive: !1 }),
                                          e.addEventListener("pointermove", this.onPointerMove, { passive: !1 }),
                                          e.addEventListener("pointerup", this.onPointerUp),
                                          e.addEventListener("pointercancel", this.onPointerUp))
                                        : (e.addEventListener("touchstart", this.onPointerDown, { passive: !1 }),
                                          e.addEventListener("touchmove", this.onPointerMove, { passive: !1 }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var t = this.$viewport;
                            window.PointerEvent
                                ? (t.removeEventListener("pointerdown", this.onPointerDown, { passive: !1 }),
                                  t.removeEventListener("pointermove", this.onPointerMove, { passive: !1 }),
                                  t.removeEventListener("pointerup", this.onPointerUp),
                                  t.removeEventListener("pointercancel", this.onPointerUp))
                                : (t.removeEventListener("touchstart", this.onPointerDown, { passive: !1 }),
                                  t.removeEventListener("touchmove", this.onPointerMove, { passive: !1 }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var t = u(this.pointers),
                                ...
                                i = t.shift();
                            return i ? { clientX: 0.5 * (e.clientX - i.clientX) + i.clientX, clientY: 0.5 * (e.clientY - i.clientY) + i.clientY } : { clientX: e ? e.clientX : 0, clientY: e ? e.clientY : 0 };
                        },
                    },
                    {
                        key: "getDistance",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            m(this.drag, { startPosition: m({}, o), startPoint: m({}, n), startDistance: this.getDistance(), endPosition: m({}, o), endPoint: m({}, n), distance: 0, distanceX: 0, distanceY: 0 }),
                                "pointerdown" === this.state && ((this.lockAxis = null), (this.drag.startTime = new Date()), (this.drag.firstPosition = Object.assign({}, o))),
                                this.stopMoving(),
                                (this.friction = this.option("friction"));
                        },
                    },
                        ...
                        value: function (t) {
                            if (t && !(t.button && t.button > 0))
                                if (this.option("panOnlyZoomed") && this.velocity.scale) t.preventDefault();
                                    ...
                                    var e;
                                    if (
                                        ((e = window.getSelection ? window.getSelection() : document.selection) && e.rangeCount && e.getRangeAt(0).getClientRects().length && (e.removeAllRanges ? e.removeAllRanges() : e.empty && e.empty()),
                                        this.pointers.length > 1 || (this.pointers.length && this.lockAxis))
                                    )
                                        t.preventDefault();
                                    else if (!1 !== this.trigger("touchStart", t))
                                        if ((t.preventDefault(), (this.state = "pointerdown"), this.addPointer(this.copyPointer(t)), this.resetDragState(), window.PointerEvent))
                                            try {
                                        ...
                                        if (1 == this.option("panOnlyZoomed") && this.current.scale === this.option("baseScale") && this.pointers.length < 2) t.preventDefault();
                                            ...
                                            if (!(this.drag.distance < 6 && (n || (this.option("lockAxis") && !this.lockAxis))) && ("pointerdown" == this.state && (this.state = "dragging"), "dragging" === this.state)) {
                                                ...
                                                var l = this.current.scale,
                                                    ...
                                                    h = 0;
                                                if (
                                                    ((this.current.scale === this.option("baseScale") && "y" === this.lockAxis) || (c = e.clientX - this.drag.startPoint.clientX),
                                                    (this.current.scale === this.option("baseScale") && "x" === this.lockAxis) || (h = e.clientY - this.drag.startPoint.clientY),
                                                    ...
                                                    (this.drag.middlePoint = e),
                                                        (l = (this.drag.startPosition.scale * this.getDistance()) / this.drag.startDistance),
                                                        (l = Math.max(Math.min(l, 2 * this.option("maxScale")), 0.5 * this.option("minScale")));
                                                    var d = this.$content.width,
                                                        u = this.$content.height,
                                                        f = d * this.drag.startPosition.scale,
                                                        v = u * this.drag.startPosition.scale,
                                                        p = u * l,
                                                        g = (d * l - f) * ((this.drag.startPoint.clientX - this.drag.startPosition.left) / f - 0.5),
                                                        m = (p - v) * ((this.drag.startPoint.clientY - this.drag.startPosition.top) / v - 0.5);
                        ...
                        value: function (t) {
                            ...
                            if ("pointerdown" === this.state || "dragging" === this.state) {
                                ...
                                var e = this.$content.getClientRects()[0],
                                    ...
                                    o = this.drag;
                                if (
                                    (m(!0, o, { elapsedTime: new Date() - o.startTime, distanceX: o.endPosition.x - o.firstPosition.x, distanceY: o.endPosition.y - o.firstPosition.y, endPosition: { top: i, left: n } }),
                                    ...
                                    if (this.current.scale < s) this.zoomTo(s, { friction: 0.64 });
                                    else {
                                    ...
                                    if (!this.clickTimer)
                                        return (
                                            ...
                                            void (this.clickTimer = setTimeout(function () {
                                                (e.clickTimer = null), !1 !== e.trigger("click", t) && "toggleZoom" === e.option("click") && e.toggleZoom({ x: i, y: n });
                                            }, this.option("clickDelay")))
                                        );
                                    this.getDistance([t, this.lastClickEvent]) >= 6 ||
                                        (clearTimeout(this.clickTimer), (this.clickTimer = null), !1 !== this.trigger("doubleClick", t) && "toggleZoom" === this.option("doubleClick") && this.toggleZoom({ x: i, y: n }));
                                } else {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            "destroy" !== this.state &&
                                ...
                                this.$content instanceof HTMLImageElement && !this.$content.complete && ((this.$content.onload = null), (this.$content.onerror = null)),
                                this.pendingAnimateUpdate && (cancelAnimationFrame(this.pendingAnimateUpdate), (this.pendingAnimateUpdate = null)),
            ...
            return (
                o(t, [
                    ...
                    },
                    {
                        key: "build",
                        value: function () {
                            this.$container || ((this.$container = document.createElement("div")), this.$container.classList.add(this.option("classNames.main")), this.carousel.$element.appendChild(this.$container)),
    ...
    var E = (function () {
            function t(e) {
                i(this, t), (this.carousel = e), (this.$list = null), (this.events = { change: this.onChange.bind(this), refresh: this.onRefresh.bind(this) });
            }
            return (
                o(t, [
                    {
            ...
            return (
                o(t, [
                    ...
                    },
                    {
                        key: "detach",
                        value: function () {
                            this.sync && (this.nav.off("ready", this.onNavReady), this.nav.off("createSlide", this.onNavCreate), this.nav.on("Panzoom.updateMetrics", this.onTargetChange), this.sync.off("change", this.onTargetChange)),
                ...
                o(n, [
                    {
                        ...
                        value: function () {
                            ...
                            ((this.$viewport = this.option("viewport") || this.$element.querySelector("." + i.viewport)), this.$viewport) ||
                                ((this.$viewport = document.createElement("div")), this.$viewport.classList.add(i.viewport), (t = this.$viewport).append.apply(t, u(this.$element.childNodes)), this.$element.appendChild(this.$viewport));
                            ((this.$track = this.option("track") || this.$element.querySelector("." + i.track)), this.$track) ||
                                ((this.$track = document.createElement("div")), this.$track.classList.add(i.track), (e = this.$track).append.apply(e, u(this.$viewport.childNodes)), this.$viewport.appendChild(this.$track));
                        },
                    },
                    {
                        key: "initSlides",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            i && (t.boundX = null), n && (t.boundY = null), i || n || (t.boundX = { from: -1 * this.pages[this.pages.length - 1].left, to: -1 * this.pages[0].left });
                        },
                    },
                    {
                        key: "initPanzoom",
                            ...
                            if (!(!this.option("infiniteX", this.option("infinite")) || this.pages.length < 2 || this.elemDimWidth < this.wrapDimWidth)) {
                                ...
                                return (
                                    t.current.x < -1 * (t.contentDim.width - t.viewportDim.width) &&
                                        ((t.current.x += t.contentDim.width), t.drag.firstPosition && (t.drag.firstPosition.x += t.contentDim.width), (this.pageIndex = this.pageIndex - this.pages.length), (e = !0)),
                            ...
                            this.slides.forEach(function (n, o) {
                                ...
                                if (s) {
                                    ...
                                    a && a.indexes && a.indexes.indexOf(o) > -1
                                        ? (e && !s.classList.contains(e) && (s.classList.add(e), t.trigger("selectSlide", n)), s.removeAttribute(i))
                                        : (e && s.classList.contains(e) && (s.classList.remove(e), t.trigger("unselectSlide", n)), s.setAttribute(i, !0));
                                }
                            });
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (Number.isInteger(r) && this.elemDimWidth > this.wrapDimWidth) for (var l = 0; l < this.slides.length; l += r) a.push({ indexes: n.slice(l, l + r), slides: this.slides.slice(l, l + r) });
                            else
                            ...
                            a.forEach(function (t, i) {
                                (t.index = i),
                                    ...
                                    p && !e.option("infiniteX", e.option("infinite")) && e.elemDimWidth > e.wrapDimWidth && ((t.left = Math.max(t.left, 0)), (t.left = Math.min(t.left, e.elemDimWidth - e.wrapDimWidth)));
                            });
                            var g,
                                m = [];
                        ...
                        value: function () {
                            ...
                            if ("init" === this.state) {
                                ...
                                i.classList.add("fancybox__thumbs"),
                                    ...
                                    (this.Carousel = new D(
                                        i,
                                        m(!0, { Dots: !1, Navigation: !1, Sync: { friction: 0 }, infinite: !1, center: !0, fill: !0, dragFree: !0, slidesPerPage: 1, preload: 1 }, this.fancybox.option("Thumbs.Carousel"), {
                        ...
                        value: function () {
                            ...
                            return (
                                this.fancybox.items.forEach(function (e) {
                                    var i = e.thumb;
                                    i && t.push({ html: '<div class="fancybox__thumb" style="background-image:url('.concat(i, ')"></div>'), customClass: "has-thumb has-".concat(e.type || "image") });
                                }),
                                t
                            );
                        },
                    },
                    {
                        ...
                        value: function () {
                            return "ready" === this.state
                                ? (this.Carousel.Panzoom.detachEvents(), (this.$wrap.style.display = "none"), void (this.state = "hidden"))
                                : "hidden" === this.state
                                ? ((this.$wrap.style.display = ""), this.Carousel.Panzoom.attachEvents(), void (this.state = "ready"))
                            ...
                            if (!e || "string" == typeof e) {
                                ...
                                i ||
                                    ...
                                    ("html5video" !== i && "video" !== i) ||
                                        ((t.video = m({}, this.fancybox.option("Html.video"), t.video)), t.width && t.height ? (t.ratio = parseFloat(t.width) / parseFloat(t.height)) : (t.ratio = t.ratio || t.video.ratio));
                            }
                        },
                    },
                    {
                                    ...
                                    case "html5video":
                                        this.fancybox.setContent(
                                            ...
                                            this.fancybox
                                                ...
                                                .replace("{{format}}", i.format || (i.html5video && i.html5video.format) || "")
                            ...
                            if (("html5video" === i.type && i.$el.querySelector("video").play(), "video" === i.type && i.$iframe && i.$iframe.contentWindow)) {
                                !(function t() {
                                    if ("done" === i.state && i.$iframe.contentWindow) {
                                        ...
                                        if (i.$iframe.isReady)
                                            return (
                                                i.video && i.video.autoplay && (e = "youtube" == i.vendor ? { event: "command", func: "playVideo" } : { method: "play", value: "true" }),
                                                void (e && i.$iframe.contentWindow.postMessage(JSON.stringify(e), "*"))
                                            );
                                        "youtube" === i.vendor && ((e = { event: "listening", id: i.$iframe.getAttribute("id") }), i.$iframe.contentWindow.postMessage(JSON.stringify(e), "*")), (i.poller = setTimeout(t, 250));
                                    }
                                })();
                            }
                        },
    ...
    var O = function (t) {
            var e = t.naturalWidth,
                ...
                s = e / i,
                a = { width: n, height: o };
            return s > n / o ? (a.height = n / s) : (a.width = o * s), (a.left = 0.5 * (n - a.width)), (a.right = e + a.left), a;
        },
        N = (function () {
            function t(e) {
                i(this, t), (this.fancybox = e);
                ...
                o(t, [
                        ...
                        value: function (t, e, i) {
                            ...
                            if (!(i.isDom || i.html || (i.type && "image" !== i.type))) {
                                ...
                                (s.onload = function () {
                                    ...
                                    s.complete || s.error ? ((s.onload = s.onerror = null), this.onImageStatusChange(i)) : s.complete || this.fancybox.showLoading(i);
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
                                ...
                                n = a && r;
                            } else n = document.elementFromPoint(s.left + 0.5 * s.width, s.top + 0.5 * s.height) === o;
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return "auto" === h && (h = Math.abs(i / n - a / r) > 0.1), { top: l, left: c, scale: e.width / a, opacity: h };
                        },
                    },
                    {
                        key: "zoomIn",
                        value: function () {
                            ...
                            if ("init" !== t.Carousel.state) {
                                ...
                                (e.state = "zoomIn"),
                                    i.detachEvents(),
                                    t.trigger("reveal", e),
                                    i.panTo({ x: -1 * s, y: -1 * o, scale: a, friction: 0, ignoreBounds: !0 }),
                                ...
                                var o = 0.75 * this.fancybox.option("Image.zoomFriction"),
                                    s = function () {
                                        var e = t.getZoomInfo(i),
                                            ...
                                            a = e.left,
                                            r = e.scale;
                                        n.panTo({ x: -1 * a, y: -1 * s, scale: r, ignoreBounds: !0, friction: o }), (o *= 0.98);
                                    };
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = t.Panzoom,
                                ...
                                n = t.$el.classList;
                            e && "toggleZoom" === i
                                ? n[e && 1 === e.current.scale && e.option("maxScale") - e.current.scale > 0.01 ? "add" : "remove"](this.fancybox.option("Image.canZoomInClass"))
                    ...
                    },
                    {
                        key: "onClick",
                        value: function (t, e) {
                            if (!(this.fancybox.Carousel.Panzoom.drag.distance >= 6 || this.fancybox.Carousel.Panzoom.lockAxis || ("IMG" != e.target.tagName && !e.target.classList.contains("fancybox__content"))))
                                switch ((e.preventDefault(), e.stopPropagation(), this.fancybox.option("Image.click"))) {
                                    case "toggleZoom":
                                        var i = e.clientX - t.$content.getClientRects()[0].left,
                                            n = e.clientY - t.$content.getClientRects()[0].top;
                                        t.toggleZoom({ x: i, y: n });
                    ...
                    },
                    {
                        key: "onRemoveSlide",
                        value: function (t, e, i) {
                            i.$image && (i.$el.classList.remove(t.option("Image.canZoomInClass")), (i.$image.onload = i.$image.onerror = null), i.$image.remove(), (i.$image = null)),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var i = this,
                                n = t.getSlide();
                            e.slides.forEach(function (t) {
                                t.Panzoom && "done" === t.state && (t.index !== n.index ? t.Panzoom.panTo({ x: 0, y: 0, scale: 1, friction: 0.8 }) : 0 === e.Panzoom.velocity.x && i.revealContent(t));
                            });
                        },
                    },
                    {
        ...
        B = {
            ...
            Hash: (function () {
                function t(e) {
                    i(this, t),
                        (this.fancybox = e),
                        (this.events = { closing: this.onClosing.bind(this), "Carousel.ready Carousel.change": this.onChange.bind(this) }),
                                ...
                                value: function () {
                                    if (!t.Fancybox.getInstance()) {
                                        ...
                                        if (n) {
                                            ...
                                            if ((s && s.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })), !t.Fancybox.getInstance())) {
                                                var a = document.querySelectorAll('[data-fancybox="'.concat(n, '"]'));
                                                a.length && (null === o && 1 === a.length ? (s = a[0]) : o && (s = a[o - 1]), s && s.dispatchEvent(new CustomEvent("click", { bubbles: !0, cancelable: !0 })));
                                            }
                                        }
                                    }
                                },
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                e && (this.$root.insertAdjacentHTML("beforeend", this.localize(e)), (this.$container = this.$root.querySelector(".fancybox__container"))),
                                    ...
                                    this.id || ((this.id = this.options.id || ++W), this.$container.setAttribute("id", "fancybox-" + this.id));
                                var i,
                                ...
                                return (
                                    t.forEach(function (t) {
                                        ...
                                        i && (e = i instanceof HTMLImageElement ? i : i.querySelector("img")),
                                            !e && t.$trigger && (e = t.$trigger instanceof HTMLImageElement ? t.$trigger : t.$trigger.querySelector("img")),
                                            (t.$thumb = e || null);
                                        var n = t.thumb;
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ...
                                    this.options.dragToClose && this.Carousel.Panzoom.on({ touchMove: this.onTouchMove, afterTransform: this.onTransform, touchEnd: this.onTouchEnd }),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (Math.abs(e) >= 150 || (Math.abs(e) >= 35 && t.drag.elapsedTime < 350)) &&
                                    (this.option("hideClass") && (this.getSlide().hideClass = "fancybox-throwOut".concat(t.current.y < 0 ? "Up" : "Down")), this.close());
                            },
                        },
                        {
                            key: "onTransform",
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                var i = !1;
                                "error" !== t.state && "ready" !== t.state && null === this.Carousel.prevPage && t.index === this.options.startIndex && (i = void 0 === t.showClass ? this.option("showClass") : t.showClass),
                                    i
                                        ? ((t.state = "animating"),
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                var c = n.getInstance();
                                return !(c && o.indexOf(c.options.$trigger) > -1) && ((s = r ? o.indexOf(r) : s), new n((o = o.map(i)), m({}, e, { startIndex: s, $trigger: r })));
                            },
                        },
                        {
                            key: "bind",
